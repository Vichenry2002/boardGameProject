...
public class OrientCard extends BaseCard {
  ...
  protected OrientCard(DeckColor paramDeckColor,
                       ...
                       String path,
                       String data) {
    super(paramDeckColor, paramBonusColor, paramCost, paramPrestigePoints, path, data);
    type = paramType;
  }
  ...
  public static OrientCard getOrientCard(String cardString, DeckColor paramDeckColor) {
    ...
    return new OrientCard(deckColor, bonusColor, cost, prestigePoints, type, imagePath, cardString);
  ...
  public void setPair(BaseCard newPair) {
    ...
    super.cardData = cardData.replace("NONE", newPair.getBonusColor().toString());
  }
